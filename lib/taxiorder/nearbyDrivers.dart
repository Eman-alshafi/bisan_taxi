...
class _TaxiScreenState extends State<TaxiScreen> {
      ...
      children: [
        Row(
          children: [
            ...
            Spacer(),
            SizedBox(height: 5),
            Text('السائق القريب منك', style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold)),
  ...
  Widget _buildConfirmButton() {
    return ElevatedButton(
      ...
      child: Text('تأكيد الطلب', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.black)),
    );
  }
}
